...
public class KackyPlayer10 extends AbstractPlayer {

	public KackyPlayer10(String playerName) {
		super(playerName);
			...
			if (emargency1 == true) {
				...
				if (emargency2 == true) {
					...
					if (maxNNR2 > maxR2 && maxNNR2 > maxNR2) {
						...
						if (isEnable(Dir, ColumnN)) {
							System.out.println("ちょい危険スルースルー10");
							action = new Action(Dir, ColumnN);
							return action;
						}
					}
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		AbstractPlayer player = new KackyPlayer10("kacky");
