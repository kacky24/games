...
public class KackyPlayer7 extends AbstractPlayer {

	public KackyPlayer7(String playerName) {
		super(playerName);
	...
	public Action doMyTurn() {
			...
			if (emargency1 == true) {
				...
				if (emargency2 == true) {
					...
					if (maxNNR2 > maxR2 && maxNNR2 > maxNR2) {
						...
						if (isEnable(Dir, ColumnN)) {
							System.out.println("ちょい危険スルースルー7");
							action = new Action(Dir, ColumnN);
							return action;
						}
					}
		...
		if (action != null) {
			System.out.println("つむつむ7");
			return action;
		}

		if (action == null) {
			System.out.println("Default7");
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		AbstractPlayer player = new KackyPlayer7("kacky");
