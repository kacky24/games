...
public class KackyPlayer1 extends AbstractPlayer {

	public KackyPlayer1(String KackyPlayer1) {
		super(KackyPlayer1);
	...
	public Action doMyTurn() {
		...
		Main:for (int i = 0; i < field.getWidth(); i++) {
			for (PuyoDirection dir : PuyoDirection.values()) {
				...
				int maxRensaNum=getMaxRensaNum(field,puyo);
				System.out.println(maxRensaNum);
				if(maxRensaNum>2){
					if(getRensaNum(i,dir,field,puyo)==maxRensaNum){
				...
				score=threeConnectNum*3+twoConnectNum-oneConnectNum;
				if(score>maxScore){
					action = new Action(dir, i);
					maxScore=score;
				}
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		AbstractPlayer player = new KackyPlayer1("かきうち");
