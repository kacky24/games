...
public class KackyPlayer9 extends AbstractPlayer {

	public KackyPlayer9(String playerName) {
		super(playerName);
	...
	public Action doMyTurn() {
			...
			if (emargency1 == true) {
				...
				if (emargency2 == true) {
					...
					if (maxNNR2 > maxR2 && maxNNR2 > maxNR2) {
						...
						if (isEnable(Dir, ColumnN)) {
							System.out.println("ちょい危険スルースルー9");
							action = new Action(Dir, ColumnN);
							return action;
						}
					}
		...
		if (action != null) {
			System.out.println("つむつむ9");
			return action;
		}

		if (action == null) {
			System.out.println("Default9");
	...
	private int getScore(int x, PuyoDirection dir) {
		...
		score = score+threeConnectNum * 4 + twoConnectNum * 2
				- oneConnectNum;
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		AbstractPlayer player = new KackyPlayer9("kacky");
